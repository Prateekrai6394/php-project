<!-- 24th...CRUD Project-->
<!--      $result->fetch_assoc()   and    mysqli_fetch_assoc($result)   Both the code are doing same work-->
        ...
        <table id="users">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {        // these 2 lines fetch data from sql
                ?>
                        <tr>
